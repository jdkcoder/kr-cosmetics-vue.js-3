...
var require_vue_smooth_scroll_min = __commonJS({
  "node_modules/vue3-smooth-scroll/dist/vue-smooth-scroll.min.js"(exports, module) {
    !function(e, t) {
      typeof exports == "object" && typeof module == "object" ? module.exports = t() : typeof define == "function" && define.amd ? define([], t) : typeof exports == "object" ? exports.VueSmoothScroll = t() : e.VueSmoothScroll = t();
    }(exports, function() {
      return function(e) {
        var t = {};
        function n(o) {
        ...
        var u = function(e2) {
          ...
          var a2, s, d = typeof t2 == "number", p = r2.scrollTop || window.pageYOffset, y = (d ? t2 : (s = p, (a2 = t2).nodeName === "HTML" ? -s : a2.getBoundingClientRect().top + s)) + n2, b = typeof f2 == "function" ? f2 : u, m = Date.now();
          !function e3() {
          ...
          e2.directive("smooth-scroll", (o(n2 = {}, i2 ? "inserted" : "mounted", function(e3, t3, n3) {
            if ((typeof window == "undefined" ? "undefined" : r(window)) === "object" && window.pageYOffset !== void 0) {
              var o2 = Object.assign(u2(), t3.value);
              typeof o2.container == "string" && (o2.container = document.querySelector(o2.container));
              var c2 = function(e4) {
                e4.preventDefault();
...
// dep:vue3-smooth-scroll
var vue3_smooth_scroll_default = require_vue_smooth_scroll_min();
export {
  vue3_smooth_scroll_default as default
};
